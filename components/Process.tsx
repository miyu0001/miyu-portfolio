...
export default function Process() {
  return (
    <section id="process" className="bg-[#FFF0EC] py-20 md:py-28">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {steps.map((s, i) => (
            <motion.div
              ...
              className="group rounded-2xl p-7 border border-black/[0.05] hover:shadow-[0_8px_32px_rgba(0,0,0,0.07)] transition-shadow duration-500"
              style={{ background: s.bg }}
            >
              <p
                className="text-[11px] font-black tracking-[0.1em] mb-5"
                style={{ color: s.color }}
              >
                {s.num}
              </p>
              ...
              <p className="text-[13px] text-[#888] leading-[1.75]">{s.desc}</p>
            </motion.div>
          ))}
        </div>
