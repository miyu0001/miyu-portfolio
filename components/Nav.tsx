    ...
    >
      <div className="mx-auto w-full max-w-[1440px] px-6 md:px-10 lg:px-16 h-20 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.14em] uppercase bg-[#111111] text-white px-5 py-2.5 rounded-full hover:bg-[#FF5A3C] transition-colors duration-300"
        >
          YouTube ↗
        </a>
        ...
        <a
          href="#contact"
          className="md:hidden text-[11px] font-bold tracking-[0.16em] uppercase text-[#111111]"
        >
          Contact
        </a>
      </div>
