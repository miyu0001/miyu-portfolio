    ...
    <section id="home" className="bg-white overflow-hidden">
      ...
      <div className="md:hidden flex flex-col" style={{ minHeight: "100svh" }}>
        ...
        <motion.div
          ...
          className="px-6 pt-28 pb-4 flex-shrink-0"
        >
          <p className="flex items-center gap-2 text-[10px] font-bold tracking-[0.26em] uppercase text-[#FF5A3C] mb-5">
            <span className="w-4 h-px bg-[#FF5A3C] shrink-0" />
            Creator / Learning in Public
          </p>
          <h1
            className="font-bold text-[#111] leading-[1.18] mb-3"
          ...
          <p className="text-[11px] font-semibold tracking-[0.14em] text-[#BBB] mb-6">
            Tokyo-based
          </p>
        ...
        <motion.div
          ...
          className="px-6 pb-5 flex gap-7 flex-shrink-0 border-b border-black/[0.06]"
        >
          {[
            ...
            <div key={s.label}>
              <p className="font-bold text-[#111] text-[17px] leading-none">{s.num}</p>
        ...
        {/* ── Arch visual ── */}
        <div className="relative flex-1 overflow-hidden flex items-end justify-center" style={{ minHeight: "360px" }}>
          ...
          <span
            ...
            style={{ opacity: 0.04, bottom: "30%", fontSize: "120px", zIndex: 0 }}
          >
            MIYU
          </span>
        ...
        {/* ── Mobile footer strip ── */}
        <div className="border-t border-black/[0.07] py-4 px-6 flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex gap-5">
            {[
              ...
              <a
                ...
                className="text-[9px] font-bold tracking-[0.14em] uppercase text-[#BBB] hover:text-[#111] transition-colors duration-300"
              >
                {s.label}
              </a>
            ))}
      ...
      {/* ══════════════════════════════════════════════
          ...
          (Exact same as before — do not touch)
      ══════════════════════════════════════════════ */}
      <div className="hidden md:block relative" style={{ minHeight: "100vh" }}>
        ...
        <motion.span
          ...
          style={{
            left: "8%",
            top: "22%",
            fontSize: "clamp(180px, 18vw, 320px)",
            zIndex: 0,
          }}
        >
          DESIGNER
        ...
        >
          ...
          <h1
            className="font-bold text-[#111] leading-[1.15] mb-4"
          ...
          <p className="text-[11px] font-semibold tracking-[0.14em] text-[#BBB] mb-8">
            Tokyo-based
          </p>
        ...
        >
          <div
            ...
            style={{
              padding: "28px",
              boxShadow: "0 16px 56px rgba(0,0,0,0.11), 0 4px 14px rgba(0,0,0,0.06)",
            }}
          >
            <div className="flex items-start justify-between mb-5">
              <div>
                <p className="font-bold text-[#111] leading-none mb-1.5" style={{ fontSize: "50px" }}>
                  7+
                </p>
                <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#AAA]">
                  Years Creating
                </p>
              </div>
              <CircleBadge />
              ...
              {[
                {
                  color: "#FF5A3C",
                  icon: (
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FF5A3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                },
                {
                  color: "#FF5A3C",
                  icon: (
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="#FF5A3C">
                ...
                },
                {
                  color: "#FF3D8B",
                  icon: (
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FF3D8B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>
                    </svg>
                  ),
                  num: "2",
                  label: "Language Apps in Dev",
                },
                {
                  color: "#FF3D8B",
                  icon: (
        ...
        {/* ── Footer strip ── */}
        <div
          className="absolute bottom-0 left-0 right-0 border-t border-black/[0.07] py-5"
          style={{ zIndex: 10 }}
        >
          <div className="mx-auto w-full max-w-[1400px] px-8 lg:px-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <p className="text-[10px] font-semibold tracking-[0.14em] uppercase text-[#CCC]">
