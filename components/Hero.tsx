        ...
        >
          <div className="bg-white rounded-2xl border border-black/[0.06]"
            ...
            <div className="border-t border-black/[0.06] pt-4 mb-5 flex flex-col gap-4">
              {[
                { color: "#FF5A3C", icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FF5A3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>, num: "1,200+", label: "Subscribers" },
